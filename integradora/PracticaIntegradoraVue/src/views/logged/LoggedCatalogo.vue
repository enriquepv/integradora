<template>
   <LoggedBasicLayout>
    <div class="catalogo">
      <div class="categoria">
        <RouterLink to = "/loggedaeg" class = "menu-link" id="menu5">
          <img id="fotoAeg" src="../../assets/playa.webp" alt="aeg">
        </RouterLink>
        <p class="texto">Productos de playa</p>
      </div>
      <div class="categoria">
        <RouterLink to = "/loggedgbb" class = "menu-link" id="menu6">
          <img id="fotoGbb" src="../../assets/piscina.jpeg" alt="gbb">
        </RouterLink>
        <p class="texto">Productos de piscina</p>
...
export default {
  ...
  mounted() {
    fetch("src/components/Productos.json")
